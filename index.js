...
var _default = {
  ...
  computed: {
    ...
    successMessage() {
      return this.$t('reporter.form.success', {
    ...
    issueLink() {
      ...
      return this.$t('reporter.form.issue.link', {
        issueLink,
        issueId
      });
    }
...
exports.default = _default;
        var $37f733 = exports.default || module.exports;
      
      if (typeof $37f733 === 'function') {
        $37f733 = $37f733.options;
      }
    
        /* template */
        Object.assign($37f733, (function () {
          var render = function() {
  var _vm = this
    ...
    [
      ...
      _c("k-form", {
        attrs: {
          fields: {
            ...
            description: {
              label: _vm.$t("reporter.form.field.description"),
              help: _vm.$t("reporter.form.field.description.help"),
              required: false,
              disabled: this.loading,
              type: "textarea",
              buttons: false
      ...
      _c(
        "k-button",
        {
          ...
          attrs: { icon: _vm.buttonIcon, disabled: _vm.loading },
          on: { click: _vm.checkForm }
        },
        [_vm._v(_vm._s(_vm.$t("reporter.form.button.save")))]
      )
    ],
    1
  )
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$37f733', $37f733);
          } else {
            api.reload('$37f733', $37f733);
          }
        }
...
var _IssueForm = _interopRequireDefault(require("./IssueForm"));
...
var _default = {
  components: {
    IssueForm: _IssueForm.default
  }
};
exports.default = _default;
        var $d5372f = exports.default || module.exports;
      
      if (typeof $d5372f === 'function') {
        $d5372f = $d5372f.options;
      }
    
        /* template */
        Object.assign($d5372f, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    "k-view",
    { staticClass: "k-issue-tracker-view" },
    [
      _c("k-header", [_vm._v(_vm._s(_vm.$t("reporter.headline")))]),
      _vm._v(" "),
      _c("k-text", [_vm._v(_vm._s(_vm.$t("reporter.description")))]),
      _vm._v(" "),
      _c("issue-form")
    ],
    1
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$d5372f', $d5372f);
          } else {
            api.reload('$d5372f', $d5372f);
          }
        }
...
},{"./IssueForm":"components/IssueForm.vue","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"components/ErrorView.vue":[function(require,module,exports) {
"use strict";
...
var _default = {};
exports.default = _default;
        var $9927ba = exports.default || module.exports;
      
      if (typeof $9927ba === 'function') {
        $9927ba = $9927ba.options;
      }
    
        /* template */
        Object.assign($9927ba, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$9927ba', $9927ba);
          } else {
            api.reload('$9927ba', $9927ba);
          }
        }
...
var _ErrorView = _interopRequireDefault(require("./components/ErrorView"));
...
panel.plugin("gearsdigital/kirby-reporter", {
  views: {
    ...
    'issue-tracker-error': {
      component: _ErrorView.default,
      menu: false
    }
  }
});
},{"./components/View":"components/View.vue","./components/ErrorView":"components/ErrorView.vue"}],"../../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
